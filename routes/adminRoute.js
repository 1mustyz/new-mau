...
// create librarian
router.post("/create-librarian", oerController.createLibrarian);

// create addmission requirement
router.post(
  "/create-admission-requirement",
  admissionRequirementController.addAddmissionRequirement
);
...
router.put(
  "/upload-campus-life-image",
  campusLifeController.addCampusLifeImage
);
...
router.put(
  ...
  interventionController.addInterventionListImage
);
...
router.put(
  "/edit-admission-requirement",
  admissionRequirementController.editAddmissionRequirement
);
...
router.put(
  "/add-facility-service-description",
  facilityController.addMoreFacilityServiceDescription
);

// add facility service tools
router.put(
  "/add-facility-service-tools",
  facilityController.addFacilityServiceTools
);

// add facility service tools image
router.put(
  "/add-facility-service-tools-image",
  facilityController.addFacilityServiceToolImage
);
...
router.get(
  "/get-department-academy-staff",
  adminController.getDepartmentAcademyStaff
);
...
router.get(
  "/get-single-principal-officer",
  adminController.getSinglePrincipalOfficer
);
...
// get single programs
router.get(
  "/get-single-program-event",
  adminController.getSingleProgramsEvents
);
...
// get all faculties
router.get(
  "/get-all-faculties-schools-college",
  adminController.getAllFacultiesSchoolsCollege
);
...
// all portals
router.get(
  "/get-all-portals-with-pagination",
  adminController.getAllPortalsWithPagination
);

// all paginated download
router.get(
  "/get-all-download-with-pagination",
  adminController.getAllDownloadsWithPagination
);
...
router.put(
  "/remove-campus-life-event",
  campusLifeController.removeCampusLifeEvent
);
...
// remove about
router.put(
  "/remove-about-leadership",
  adminController.removeAboutLeadershipContent
);
...
router.put(
  "/edit-intervention-list",
  interventionController.editInterventionList
);
...
router.put(
  "/add-intervention-list",
  interventionController.addInterventionList
);

// add department from file
router.put(
  "/add-department-from-file",
  adminController.createDepartmentFromAfile
);
...
router.put(
  ...
  idChecker.checkId,
  adminController.addDepartmentStaff
);
...
router.put(
  "/add-department-program-from-file",
  adminController.createProgranFromAfile
);
...
router.put(
  "/remove-department-program",
  adminController.removeDepartmentProgram
);

// remove all department program
router.put(
  "/remove-all-department-program",
  adminController.removeAllDepartmentProgram
);
...
router.put(
  "/remove-intervention-list",
  interventionController.removeInterventionList
);

// remove intervention
router.delete(
  "/remove-intervention",
  interventionController.removeIntervention
);
...
router.delete(
  ...
  admissionRequirementController.removeAddmissionRequirement
);
